...
#Orange-D CTRL
$Computers = (Get-ADComputer -Filter * -SearchBase "OU=Green-E,OU=ASDA-CTRL,OU=ASDADesktops,OU=SITES,OU=ASDA,DC=ASD,DC=MSP,DC=htec,DC=co,DC=uk" -Server asd.msp.htec.co.uk | Select-Object -ExpandProperty DNSHostName) 
